...
def widgets(self):
    ...
    # add to layout
    self.preLabel.grid(column=0, row=0, padx=(4,2), pady=(4,2), sticky='e')
    self.preEntry.grid(column=1, row=0, padx=(2,4), pady=2, sticky='ew', columnspan=3)
    self.pstLabel.grid(column=0, row=1, padx=(4,2), pady=2, sticky='e')
    self.pstEntry.grid(column=1, row=1, padx=(2,4), pady=2, sticky='ew', columnspan=3)
    self.llLabel.grid(column=0, row=2, padx=4, pady=2, sticky='ew', columnspan=4)
    ...
    self.shLabel.grid(column=0, row=4, padx=4, pady=2, sticky='ew', columnspan=4)
    self.dLabel.grid(column=0, row=5, padx=(4,2), pady=2, sticky='e')
    self.shEntry.grid(column=1, row=5, padx=2, pady=2, sticky='w')
    self.hsLabel.grid(column=2, row=5, padx=2, pady=2, sticky='e')
    self.hsEntry.grid(column=3, row=5, padx=(2,4), pady=2, sticky='w')
    self.pvLabel.grid(column=0, row=6, padx=4, pady=2, sticky='ew', columnspan=4)
    self.spLabel.grid(column=0, row=7, padx=(4,2), pady=2, sticky='e')
    self.spButton.grid(column=1, row=7, padx=2, pady=2, sticky='w')
