...
def widgets(self):
    ...
    self.lLabel.grid(column=0, row=4, padx=(4,2), pady=2, sticky='e')
    self.lEntry.grid(column=1, row=4, padx=2, pady=2, sticky='w')
    self.wLabel.grid(column=0, row=5, padx=(4,2), pady=2, sticky='e')
    self.wEntry.grid(column=1, row=5, padx=2, pady=2, sticky='w')
