...
def widgets(self):
    ...
    self.dLabel.grid(column=0, row=4, padx=3, pady=3, sticky='e')
    self.dEntry.grid(column=1, row=4, padx=3, pady=3, sticky='w')
    self.hdLabel.grid(column=0, row=5, padx=3, pady=3, sticky='e')
    self.hdEntry.grid(column=1, row=5, padx=3, pady=3, sticky='w')
    self.hoLabel.grid(column=0, row=6, padx=3, pady=3, sticky='e')
    self.hoEntry.grid(column=1, row=6, padx=3, pady=3, sticky='w')
    self.bcaLabel.grid(column=0, row=7, padx=3, pady=3, sticky='e')
    self.bcaEntry.grid(column=1, row=7, padx=3, pady=3, sticky='w')
    self.ocLabel.grid(column=0, row=8, padx=3, pady=3, sticky='e')
    self.ocEntry.grid(column=1, row=8, padx=3, pady=3, sticky='w')
    self.ocButton.grid(column=2, row=8, padx=3, pady=3, sticky='w')
