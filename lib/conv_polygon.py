...
def widgets(self):
    ...
    self.polyLabel.grid(column=0, row=4, padx=3, pady=3, sticky='e')
    self.polyCombo.grid(column=1, row=4, padx=3, pady=3, columnspan=2, sticky='ew')
    self.sLabel.grid(column=0, row=5, padx=3, pady=3, sticky='e')
    self.sEntry.grid(column=1, row=5, padx=3, pady=3, sticky='w')
    self.dLabel.grid(column=0, row=6, padx=3, pady=3, sticky='e')
    self.dEntry.grid(column=1, row=6, padx=3, pady=3, sticky='w')
