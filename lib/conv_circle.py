...
def widgets(self):
    ...
    self.ocLabel.grid(column=0, row=5, padx=3, pady=3, sticky='e')
    self.ocEntry.grid(column=1, row=5, padx=3, pady=3, sticky='w')
    self.ocButton.grid(column=2, row=5, padx=3, pady=3, sticky='e')
    # finish setup
    self.dEntry.focus()
