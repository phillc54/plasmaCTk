...
def widgets(self):
    ...
    self.rLabel.grid(column=0, row=4, padx=3, pady=3, sticky='e')
    self.rEntry.grid(column=1, row=4, padx=3, pady=3, sticky='w')
    self.saLabel.grid(column=0, row=5, padx=3, pady=3, sticky='e')
    self.saEntry.grid(column=1, row=5, padx=3, pady=3, sticky='w')
