...
def widgets(self):
    ...
    self.rLabel.grid(column=0, row=4, padx=(4,2), pady=2, sticky='e')
    self.rEntry.grid(column=1, row=4, padx=2, pady=2, sticky='w')
    self.saLabel.grid(column=0, row=5, padx=(4,2), pady=2, sticky='e')
    self.saEntry.grid(column=1, row=5, padx=2, pady=2, sticky='w')
