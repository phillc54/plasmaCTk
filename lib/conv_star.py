...
def widgets(self):
    ...
    self.pLabel.grid(column=0, row=4, padx=(4,2), pady=2, sticky='e')
    self.pEntry.grid(column=1, row=4, padx=2, pady=2, sticky='w')
    self.odLabel.grid(column=0, row=5, padx=(4,2), pady=2, sticky='e')
    self.odEntry.grid(column=1, row=5, padx=2, pady=2, sticky='w')
    self.idLabel.grid(column=0, row=6, padx=(4,2), pady=2, sticky='e')
    self.idEntry.grid(column=1, row=6, padx=2, pady=2, sticky='w')
