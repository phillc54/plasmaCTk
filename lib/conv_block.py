...
#    self.addC.configure(state = 'disabled')
    ...
    #add to layout
    self.ccLabel.grid(column=0, row=0, padx=4, pady=(4,2), columnspan=4, sticky='ew')
    self.cnLabel.grid(column=0, row=1, padx=(4,2), pady=2, sticky='e')
    self.cnEntry.grid(column=1, row=1, padx=2, pady=2, sticky='w')
    self.coLabel.grid(column=2, row=1, padx=2, pady=2, sticky='e')
    self.coEntry.grid(column=3, row=1, padx=(2,4), pady=2, sticky='w')
    self.rrLabel.grid(column=0, row=2, padx=4, pady=(8,0), columnspan=4, sticky='ew')
    self.rnLabel.grid(column=0, row=3, padx=(4,2), pady=2, sticky='e')
    self.rnEntry.grid(column=1, row=3, padx=2, pady=2, sticky='w')
    self.roLabel.grid(column=2, row=3, padx=2, pady=2, sticky='e')
    self.roEntry.grid(column=3, row=3, padx=(2,4), pady=2, sticky='w')
    self.bsLabel.grid(column=0, row=4, padx=4, pady=(8,0), columnspan=4, sticky='ew')
    self.scLabel.grid(column=0, row=5, padx=(4,2), pady=2, sticky='e')
    self.scEntry.grid(column=1, row=5, padx=2, pady=2, sticky='w')
    self.rtLabel.grid(column=2, row=5, padx=2, pady=2, sticky='e')
    self.rtEntry.grid(column=3, row=5, padx=(2,4), pady=2, sticky='w')
    self.mirror.grid(column=1, row=6, padx=2, pady=2, sticky='w')
    self.flip.grid(column=3, row=6, padx=(2,4), pady=2, sticky='w')
    self.oLabel.grid(column=0, row=7, padx=4, pady=(8,0), columnspan=4, sticky='ew')
    self.xsLabel.grid(column=0, row=8, padx=(4,2), pady=2, sticky='e')
    self.xsEntry.grid(column=1, row=8, padx=2, pady=2, sticky='w')
    self.ysLabel.grid(column=2, row=8, padx=2, pady=2, sticky='e')
    self.ysEntry.grid(column=3, row=8, padx=(2,4), pady=2, sticky='w')
