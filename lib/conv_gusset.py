...
def widgets(self):
    ...
    self.hLabel.grid(column=0, row=5, padx=3, pady=3, sticky='e')
    self.hEntry.grid(column=1, row=5, padx=3, pady=3, sticky='w')
    self.rButton.grid(column=0, row=6, padx=3, pady=3, sticky='w')
    self.rEntry.grid(column=1, row=6, padx=3, pady=3, sticky='w')
