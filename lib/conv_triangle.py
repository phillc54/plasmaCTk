...
def widgets(self):
    ...
    self.aaLabel.grid(column=0, row=4, padx=3, pady=3, sticky='e')
    self.aaEntry.grid(column=1, row=4, padx=3, pady=3, sticky='w')
    self.alLabel.grid(column=2, row=4, padx=3, pady=3, sticky='e')
    self.alEntry.grid(column=3, row=4, padx=3, pady=3, sticky='w')
    self.baLabel.grid(column=0, row=5, padx=3, pady=3, sticky='e')
    self.baEntry.grid(column=1, row=5, padx=3, pady=3, sticky='w')
    self.blLabel.grid(column=2, row=5, padx=3, pady=3, sticky='e')
    self.blEntry.grid(column=3, row=5, padx=3, pady=3, sticky='w')
    self.caLabel.grid(column=0, row=6, padx=3, pady=3, sticky='e')
    self.caEntry.grid(column=1, row=6, padx=3, pady=3, sticky='w')
    self.clLabel.grid(column=2, row=6, padx=3, pady=3, sticky='e')
    self.clEntry.grid(column=3, row=6, padx=3, pady=3, sticky='w')
    self.aLabel.grid(column=0, row=7, padx=3, pady=3, sticky='e')
    self.aEntry.grid(column=1, row=7, padx=3, pady=3, sticky='w')
    # finish setup
    self.aaEntry.focus()
